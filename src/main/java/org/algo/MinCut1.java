...
public class MinCut1 {
	...
	private static final String FILE = "kargerMinCut.txt";
	// String FILE = "kargerAdj.txt";
	...
	private void calculate() {
		while (adjList.size() > 2) {
			...
			/*
			 * start_vertex = start_vertex U end_vertex 1. Find all vertices connected to
			 * end_vertex as aux vertices 2. Remove the end_vertex from the vertex list for
			 * each aux vertex 3. Add the start_vertex from the vertex list for each aux
			 * vertex 4. Add the aux vertices to the start_vertex list 5. Remove the
			 * end_vertex list from adjList 6. Remove self loops in start_vertex
			 */
